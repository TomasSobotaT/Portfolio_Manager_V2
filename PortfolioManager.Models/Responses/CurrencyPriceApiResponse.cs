namespace PortfolioManager.Models.Responses.Currency;
...
public class AUD
{
    ...
    public decimal? dev_stred { get; set; }
    public decimal? dev_nakup { get; set; }
    public decimal? dev_prodej { get; set; }
...
public class GBP
{
    ...
    public decimal? dev_nakup { get; set; }
    public decimal? dev_prodej { get; set; }
    public decimal? val_stred { get; set; }
    public decimal? val_nakup { get; set; }
    public decimal? val_prodej { get; set; }
    public string nazev { get; set; }
    public string url { get; set; }
}
